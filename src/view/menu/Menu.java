		...
		extends BasicGameState
{
	...
	{
		menuBackground = new Image ( SaveLocation.LOCATION + "\\Graphics\\Menu\\menuBackground.PNG" );
		playNow = new Image ( SaveLocation.LOCATION + "\\Graphics\\Menu\\playNow.PNG" );
		exitGame = new Image ( SaveLocation.LOCATION + "\\Graphics\\Menu\\exitGame.PNG" );
		rightArrow = new Image ( SaveLocation.LOCATION + "\\Graphics\\Menu\\rightArrow2.PNG" );
	...
	public void update ( GameContainer gc, StateBasedGame sbg, int delta ) throws SlickException
	{
		...
		if ( input.isKeyDown ( Input.KEY_ENTER ) )
		{
			if ( playNowPointer )
			{
				sbg.enterState ( StateEnum.PLAY.getValue (), new FadeOutTransition ( Color.black, 1000 ), new FadeInTransition ( Color.black, 400 ) );
			}
			else
				System.exit ( 0 );
		}
